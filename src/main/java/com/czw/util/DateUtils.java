...
public class DateUtils {
    ...
    /**
     * 功能: 将传入的日期对象按照yyyyMMddHHmmss格式转换成字符串返回
     * 例：20130603110422
     * @param date
     * @return
     */
	...
	public static int DateDiff(String date1, String date2) {
		...
		return Math.abs(DateDiff(StringToDateTime(date1),
				StringToDateTime(date2))) + 1;
	}
	...
	public static String getTimeAddMinute(String time,int minute){
		...
		nowTime.setTime(StringToDateTime(time));
		nowTime.add(Calendar.MINUTE, minute);
		return DateTimeToString(nowTime.getTime());
	}
